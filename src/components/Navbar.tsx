  ...
  return (
    <header className="py-6 px-4 sm:px-6 lg:px-8 border-b border-gray-800">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <a href="#contact" className="hidden sm:inline-block bg-teal-500 text-white font-semibold py-2 px-4 rounded-lg shadow-xl hover:bg-teal-400 transition-colors">Connect</a>
      </div>
    </header>
  );
};
